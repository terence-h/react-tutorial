...
export default function CreatingAHook() {
  return (
    <article id="creating-a-hook">
      ...
      <InformationText className="mt-5"><Paragraph>Did you notice that the states of the button are not shared while in Context API section, the state is shared across all components.
        <br /><br />Context API provides <span className="underline">1 state</span> to ALL nested components. In the case of this custom hook, we are providing a new state to EACH component.</Paragraph>
      </InformationText>
    </article>
  );
}
