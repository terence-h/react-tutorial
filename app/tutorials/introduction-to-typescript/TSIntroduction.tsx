...
export default function TSIntroduction() {
    return (
        <article id="introduction">
            ...
            <Paragraph className="mt-5">TypeScript is a superset of JavaScript; this means that any valid JavaScript code is also valid TypeScript code. What TypeScript offers over JavaScript are better error checking, maintainability and productivity in larger/team projects which we will dive deeper later on.</Paragraph>
        </article>
    );
}