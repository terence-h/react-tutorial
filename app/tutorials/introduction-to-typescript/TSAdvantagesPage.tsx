...
import jsAdvStaticType1 from '@/public/tutorials/introduction-to-typescript/js-advantage-static-typing-1.jpg';
import tsAdvStaticType1 from '@/public/tutorials/introduction-to-typescript/ts-advantage-static-typing-1.jpg';
import jsAdvStaticTypeFunc1 from '@/public/tutorials/introduction-to-typescript/js-advantage-static-typing-func-1.jpg';
import tsAdvStaticTypeFunc1 from '@/public/tutorials/introduction-to-typescript/ts-advantage-static-typing-func-1.jpg';
import tsAdvInterface1 from '@/public/tutorials/introduction-to-typescript/ts-advantage-interface-1.jpg';
import tsAdvInterface2 from '@/public/tutorials/introduction-to-typescript/ts-advantage-interface-2.jpg';
import tsAdvAutoCompletion1 from '@/public/tutorials/introduction-to-typescript/ts-advantage-autocompletion-1.jpg';
...
export default function TSAdvantagesPage() {
    return (
        <article id="advantages">
            ...
            <Paragraph className="mt-5">Notice that in the TypeScript code, it highlights an error in red underline. TypeScript supports type inference. This means TypeScript recognises &quot;iAmANumber&quot; is of type number and throws an error when assigning a non-number to it during compile time.</Paragraph>
