...
const data: TableRow[] = [
    ...
    { 'No.': 7, 'Tutorial': 'Rendering Conditionally and Dynamic Content', 'Estimated Duration': '2 hours' },
    { 'No.': 8, 'Tutorial': 'Side Effects with useEffect', 'Estimated Duration': '2 hours' },
    { 'No.': 9, 'Tutorial': 'Managing Complex States with Context API', 'Estimated Duration': '3 hours' },
    { 'No.': 10, 'Tutorial': 'Building Reusable Custom Hooks', 'Estimated Duration': '2 hours' },
    { 'No.': 11, 'Tutorial': 'Routing for Apps with Multiple Pages', 'Estimated Duration': '3 hours' },
    { 'No.': 12, 'Tutorial': 'Error Boundaries', 'Estimated Duration': '1 hour' },
    { 'No.': 13, 'Tutorial': 'Case Study', 'Estimated Duration': '5 days' },
];