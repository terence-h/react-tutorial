    ...
    return (
        <article id="passing-props">
            ...
            <Paragraph>Passing props (or prop drilling) is one of the key features in React you will use very often during development.
                <br />We will start with the Header component adding some styles and changing how the text is displayed so it can be changed when reusing the component.
            </Paragraph>
            ...
            <InformationText className="mt-5 mb-5">If you are using TypeScript in React, you might get a warning: Parameter &apos;props&apos; implicitly has an &apos;any&apos; type.
                <br />Remember that TypeScript wants properties to be inferred and preferably not using the &quot;any&quot; type as it opens to potential bugs caused by human error, especially in larger projects.
                <br />If you are unsure what type to use, you can hover over the &quot;style&quot; in the {`<h1>`} element in your VSCode editor and it will indicate what type it is expecting.</InformationText>
            ...
            <Paragraph className="mt-5">Now that we have successfully changed the Header component so that you can create different styling of the Header component, let&apos;s change the hardcoded text so it can be different for every Header.
                <br />In both the Header and Button component, simply replace the text with &quot;props.children&quot;.
                <br />Try adding more Header components and Button components with different styling and text!
            </Paragraph>
            ...
            <InformationText className="mt-5 mb-5">Do you notice that we have to type props.xyz every time we want to reference a prop? Isn&apos;t it quite repetitive?
                <br />If you have a decent amount of experience in JavaScript, you should know that you can destructure objects. You can do so in React too!
            </InformationText>
