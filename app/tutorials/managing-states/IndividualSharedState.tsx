...
export default function IndividualSharedState() {
    return (
        <article id="individual-shared-states">
            ...
            <Paragraph className="mt-5">With that said, can you try and separate the shared state into individual state to each ButtonWithCounter component? Use the code editor provided above. Some tips have been provided below to help you out.</Paragraph>
